...
'ACP_KNOWLEDGEBASE_ARTICLE_EDITED_LOG'		=> '<strong>Edited Knowledge Base article</strong><br />» %s',
	...
	'ACP_KNOWLEDGEBASE_INVALID_HASH'			=> 'De link is beschadigd. De hash is ongeldig.',
	'ACP_KNOWLEDGEBASE_ARTICLES'								=> 'Artikels',
	'ACP_KNOWLEDGEBASE_CATEGORIES'							=> 'Categorie&euml;n',
	'ACP_KNOWLEDGEBASE_CATEGORY_SETTINGS'						=> 'Categorie instellingen',
	'ACP_KNOWLEDGEBASE_CATEGORY_NAME'							=> 'Categorie naam',
	'ACP_KNOWLEDGEBASE_CATEGORY_NAME_EXPLAIN'					=> 'Categorie namen worden getoond op de index, viewcategory en viewarticle pagina. Categorie namen worden ook gebruikt om je categorie&euml;n te identificeren wanneer je ze beheert in het beheerderspaneel.',
	'ACP_KNOWLEDGEBASE_CATEGORY_DESCRIPTION'					=> 'Categorie beschrijving',
	'ACP_KNOWLEDGEBASE_CATEGORY_DESCRIPTION_EXPLAIN'			=> 'De categorie beschrijving wordt getoond op de viewcategory pagina.',
	'ACP_KNOWLEDGEBASE_ADD_CATEGORY'							=> 'Maak nieuwe categorie',
	'ACP_KNOWLEDGEBASE_DELETE_ARTICLES'						=> 'Verwijder artikels',
	'ACP_KNOWLEDGEBASE_MOVE_ARTICLES'							=> 'Verplaatst artikels',
	'ACP_KNOWLEDGEBASE_DELETE_CATEGORY_CONFIRM'				=> 'Ben je zeker dat u deze categorie wenst te verwijderen?',
	'ACP_KNOWLEDGEBASE_CATEGORY_ADDED'						=> 'Categorie succesvol toegevoegd.',
	'ACP_KNOWLEDGEBASE_CATEGORY_DELETED'						=> 'Categorie succesvol verwijderd.',
	'ACP_KNOWLEDGEBASE_CATEGORY_EDITED'						=> 'Categorie succesvol bewerkt.',
));
