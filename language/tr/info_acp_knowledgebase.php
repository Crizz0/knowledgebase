...
'ACP_KNOWLEDGEBASE_ARTICLE_EDITED_LOG'		=> '<strong>Edited Knowledge Base article</strong><br />» %s',
	...
	'ACP_KNOWLEDGEBASE_INVALID_HASH'			=> 'Bağlantı bozuk. Hash geçersiz.',
	'ACP_KNOWLEDGEBASE_ARTICLES'								=> 'Makaleler',
	'ACP_KNOWLEDGEBASE_CATEGORIES'							=> 'Kategoriler',
	'ACP_KNOWLEDGEBASE_CATEGORY_SETTINGS'						=> 'Kategori ayarları',
	'ACP_KNOWLEDGEBASE_CATEGORY_NAME'							=> 'Kategori adı',
	'ACP_KNOWLEDGEBASE_CATEGORY_NAME_EXPLAIN'					=> 'Her makale için ana sayfada, kategori görüntüleme sayfasında ve makale görüntüleme sayfasında kategori adları gösterilir. Kategori adları, kategorilerinizi YKP’den yönetirken tanımlamak için de kullanır.',
	'ACP_KNOWLEDGEBASE_CATEGORY_DESCRIPTION'					=> 'Kategori açıklaması',
	'ACP_KNOWLEDGEBASE_CATEGORY_DESCRIPTION_EXPLAIN'			=> 'Kategori açıklaması, bir kategori seçildiğinde ana sayfada görüntülenir.',
	'ACP_KNOWLEDGEBASE_ADD_CATEGORY'							=> 'Yeni kategori oluştur',
	'ACP_KNOWLEDGEBASE_DELETE_ARTICLES'						=> 'Makaleleri sil',
	'ACP_KNOWLEDGEBASE_MOVE_ARTICLES'							=> 'Makaleleri taşı',
	'ACP_KNOWLEDGEBASE_DELETE_CATEGORY_CONFIRM'				=> 'Bu kategoriyi kaldırmak istediğinize emin misiniz?',
	'ACP_KNOWLEDGEBASE_CATEGORY_ADDED'						=> 'Kategori başarıyla eklendi.',
	'ACP_KNOWLEDGEBASE_CATEGORY_DELETED'						=> 'Kategori başarıyla kaldırıldı.',
	'ACP_KNOWLEDGEBASE_CATEGORY_EDITED'						=> 'Kategori başarıyla düzenlendi.',
));
