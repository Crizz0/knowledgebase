...
'ACP_KNOWLEDGEBASE_ARTICLE_EDITED_LOG'		=> '<strong>Edited Knowledge Base article</strong><br />» %s',
	...
	'ACP_KNOWLEDGEBASE_INVALID_HASH'			=> 'O link está corrompido. O hash é inválido.',
	'ACP_KNOWLEDGEBASE_ARTICLES'								=> 'Artigos',
	'ACP_KNOWLEDGEBASE_CATEGORIES'							=> 'Categorias',
	'ACP_KNOWLEDGEBASE_CATEGORY_SETTINGS'						=> 'Configurações da categoria',
	'ACP_KNOWLEDGEBASE_CATEGORY_NAME'							=> 'Nome da categoria',
	'ACP_KNOWLEDGEBASE_CATEGORY_NAME_EXPLAIN'					=> 'Nomes de categoria são exibidos na página de índice para cada artigo, a página de viewcategory e a página de viewarticle. Nomes de categorias também são usados ​​para identificar suas categorias ao gerenciá-las no ACP.',
	'ACP_KNOWLEDGEBASE_CATEGORY_DESCRIPTION'					=> 'Descrição da categoria',
	'ACP_KNOWLEDGEBASE_CATEGORY_DESCRIPTION_EXPLAIN'			=> 'A descrição da categoria é exibida na página de índice quando uma categoria é selecionada.',
	'ACP_KNOWLEDGEBASE_ADD_CATEGORY'							=> 'Criar categoria',
	'ACP_KNOWLEDGEBASE_DELETE_ARTICLES'						=> 'Deletar artigos',
	'ACP_KNOWLEDGEBASE_MOVE_ARTICLES'							=> 'Mover artigos',
	'ACP_KNOWLEDGEBASE_DELETE_CATEGORY_CONFIRM'				=> 'Tem certeza de que deseja remover esta categoria?',
	'ACP_KNOWLEDGEBASE_CATEGORY_ADDED'						=> 'Categoria adicionada com sucesso.',
	'ACP_KNOWLEDGEBASE_CATEGORY_DELETED'						=> 'Categoria removida com sucesso',
	'ACP_KNOWLEDGEBASE_CATEGORY_EDITED'						=> 'Categoria editada com sucesso.',
));
