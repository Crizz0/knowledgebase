...
'ACP_KNOWLEDGEBASE_ARTICLE_EDITED_LOG'		=> '<strong>Edited Knowledge Base article</strong><br />» %s',
	...
	'ACP_KNOWLEDGEBASE_INVALID_HASH'			=> 'Le lien est corrompu. Le hachage n’est pas valide.',
	'ACP_KNOWLEDGEBASE_ARTICLES'								=> 'Articles',
	'ACP_KNOWLEDGEBASE_CATEGORIES'							=> 'Catégories',
	'ACP_KNOWLEDGEBASE_CATEGORY_SETTINGS'						=> 'Paramètres de la catégorie',
	'ACP_KNOWLEDGEBASE_CATEGORY_NAME'							=> 'Nom de la catégorie',
	'ACP_KNOWLEDGEBASE_CATEGORY_NAME_EXPLAIN'					=> 'Le nom des catégories est affiché en tant que lien sur chaque article de la page d’accueil de la base de connaissance et sur la page de visualisation des articles. Le nom des catégories est aussi utilisé pour identifier vos catégories dans le panneau d’administration.',
	'ACP_KNOWLEDGEBASE_CATEGORY_DESCRIPTION'					=> 'Description de la catégorie',
	'ACP_KNOWLEDGEBASE_CATEGORY_DESCRIPTION_EXPLAIN'			=> 'La description est affichée sur la page d’index quand une catégorie est sélectionnée.',
	'ACP_KNOWLEDGEBASE_ADD_CATEGORY'							=> 'Créer une nouvelle catégorie',
	'ACP_KNOWLEDGEBASE_DELETE_ARTICLES'						=> 'Supprimer les articles',
	'ACP_KNOWLEDGEBASE_MOVE_ARTICLES'							=> 'Déplacer les articles vers',
	'ACP_KNOWLEDGEBASE_DELETE_CATEGORY_CONFIRM'				=> 'Êtes-vous sûr de vouloir supprimer cette catégorie ?',
	'ACP_KNOWLEDGEBASE_CATEGORY_ADDED'						=> 'La catégorie a été ajoutée.',
	'ACP_KNOWLEDGEBASE_CATEGORY_DELETED'						=> 'La catégorie a été supprimée.',
	'ACP_KNOWLEDGEBASE_CATEGORY_EDITED'						=> 'La catégorie a été modifiée.',
));
