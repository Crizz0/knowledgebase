...
$lang = array_merge($lang, array(
	...
	'ACP_KNOWLEDGEBASE_DELETE_CATEGORY_NOT_UPDATED'	=> array(
		1	=> 'Kategorie erfolgreich gelöscht.<br /><br />Bitte beachten Sie, dass es in dieser Kategorie bereits %d Artikel gab, der einer neuen Kategorie angehörte. Der folgende Artikel war bereits vorhanden:<br />%s',
		2	=> 'Kategorie erfolgreich gelöscht.<br /><br />Bitte beachten Sie, dass es in dieser Kategorie bereits %d Artikel gab, die einer neuen Kategorie angehörten. Die folgenden Artikel war bereits vorhanden:<br />%s',
	),
	'ACP_KNOWLEDGEBASE_DELETE_CATEGORY_NOT_DELETED'	=> array(
		1	=> 'Kategorie erfolgreich gelöscht.<br /><br />Bitte beachten Sie, dass es in dieser Kategorie bereits %d Artikel gab, der einer anderen Kategorie angehörte. Der folgende Artikel wurde <b><u>nicht</u></b> gelöscht:<br />%s',
		2	=> 'Kategorie erfolgreich gelöscht.<br /><br />Bitte beachten Sie, dass es in dieser Kategorie bereits %d Artikel gab, die einer anderen Kategorie angehörten. Die folgenden Artikel wurden <b><u>nicht</u></b> gelöscht:<br />%s',
	),
	...
	'ACP_KNOWLEDGEBASE_CATEGORY_NAME_EXPLAIN'					=> 'Die Kategorienamen werden allen Übersichtsseiten und im Artikel angezeigt. Kategorienamen werden auch verwendet, um die Kategorien im ACP zu identifizieren.',
