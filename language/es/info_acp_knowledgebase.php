...
'ACP_KNOWLEDGEBASE_ARTICLE_EDITED_LOG'		=> '<strong>Edited Knowledge Base article</strong><br />» %s',
	...
	'ACP_KNOWLEDGEBASE_INVALID_HASH'			=> 'El enlace está dañado. El hash no es válido.',
	'ACP_KNOWLEDGEBASE_ARTICLES'								=> 'Artículos',
	'ACP_KNOWLEDGEBASE_CATEGORIES'							=> 'Categorías',
	'ACP_KNOWLEDGEBASE_CATEGORY_SETTINGS'						=> 'Ajustes de categoría',
	'ACP_KNOWLEDGEBASE_CATEGORY_NAME'							=> 'Nombre de la categoría',
	'ACP_KNOWLEDGEBASE_CATEGORY_NAME_EXPLAIN'					=> 'Los nombres de categoría se muestran en la página de índice para cada artículo, la página (viendo una categoría), y la página (viendo un artículos). Los nombres de categoría también se utilizan para identificar sus categorías al administrarlas en el PCA.',
	'ACP_KNOWLEDGEBASE_CATEGORY_DESCRIPTION'					=> 'Descripción de la categoría',
	'ACP_KNOWLEDGEBASE_CATEGORY_DESCRIPTION_EXPLAIN'			=> 'La descripción de la categoría se muestra en la página de índice cuando se selecciona una categoría.',
	'ACP_KNOWLEDGEBASE_ADD_CATEGORY'							=> 'Crear nueva categoría',
	'ACP_KNOWLEDGEBASE_DELETE_ARTICLES'						=> 'Borrar artículos',
	'ACP_KNOWLEDGEBASE_MOVE_ARTICLES'							=> 'Mover artículos',
	'ACP_KNOWLEDGEBASE_DELETE_CATEGORY_CONFIRM'				=> '¿Está segurto de querer eliminar esta categoría?',
	'ACP_KNOWLEDGEBASE_CATEGORY_ADDED'						=> 'Categoría añadida correctamente.',
	'ACP_KNOWLEDGEBASE_CATEGORY_DELETED'						=> 'Categoría eliminada correctamente.',
	'ACP_KNOWLEDGEBASE_CATEGORY_EDITED'						=> 'Categoría editada correctamente.',
));
