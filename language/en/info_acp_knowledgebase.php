...
$lang = array_merge($lang, array(
	...
	'ACP_KNOWLEDGEBASE_INVALID_HASH'			=> 'The link is corrupted. The hash is invalid.',
	'ACP_KNOWLEDGEBASE_ARTICLES'								=> 'Articles',
	'ACP_KNOWLEDGEBASE_CATEGORIES'							=> 'Categories',
	'ACP_KNOWLEDGEBASE_CATEGORY_SETTINGS'						=> 'Category settings',
	'ACP_KNOWLEDGEBASE_CATEGORY_NAME'							=> 'Category name',
	'ACP_KNOWLEDGEBASE_CATEGORY_NAME_EXPLAIN'					=> 'Category names are displayed on the index page for each article, the viewcategory page and the viewarticle page. Category names are also used to identify your categories when managing them in the ACP.',
	'ACP_KNOWLEDGEBASE_CATEGORY_DESCRIPTION'					=> 'Category description',
	'ACP_KNOWLEDGEBASE_CATEGORY_DESCRIPTION_EXPLAIN'			=> 'The category description is displayed on the index page when a category is selected.',
	'ACP_KNOWLEDGEBASE_ADD_CATEGORY'							=> 'Create new category',
	'ACP_KNOWLEDGEBASE_DELETE_ARTICLES'						=> 'Delete articles',
	'ACP_KNOWLEDGEBASE_MOVE_ARTICLES'							=> 'Move articles',
	'ACP_KNOWLEDGEBASE_DELETE_CATEGORY_CONFIRM'				=> 'Are you sure you want to remove this category?',
	'ACP_KNOWLEDGEBASE_CATEGORY_ADDED'						=> 'Category successfully added.',
	'ACP_KNOWLEDGEBASE_CATEGORY_DELETED'						=> 'Category successfully removed.',
	'ACP_KNOWLEDGEBASE_CATEGORY_EDITED'						=> 'Category successfully edited.',
));
