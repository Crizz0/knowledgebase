 ...
 */
class disapprove_article extends \phpbb\notification\type\base
{
	...
	{
		return 'kinerity.knowledgebase.notification.type.disapprove_article';
	}
	...
	public function find_users_for_notification($data, $options = array())
	{
		...
		$users[$data['article_poster_id']] = $this->notification_manager->get_default_methods();
	...
	public function get_title()
	{
		return $this->language->lang(
			'KB_NOTIFICATION_ARTICLE_DISAPPROVED',
